  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (error) {
        ...
        // Show email confirmation notice if applicable
        if (!data.session) {
          alert('Please check your email for a confirmation link to complete the signup process.');
        }
      }
    } catch (err) {
              ...
              <div className="mt-2 space-y-2">
                ...
                <div className="flex items-center">
                  <input
                    ...
                    className="focus:ring-primary h-4 w-4 text-primary border-gray-300"
                  />
                  <label htmlFor="guide" className="ml-3 block text-sm font-medium text-gray-700">
                    Tour Guide
                  </label>
                </div>
              </div>
